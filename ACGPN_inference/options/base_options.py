...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--workers', default=32, type=int, help='# threads for loading data')
        ...
        self.parser.add_argument('--save_count', type=int, default=2000, help='number of epochs that we only train the outmost local enhancer')
