...
lambdas = {'adv': 0.25, 'adv_identity': 10, 'identity': 500, 'match_gt': 20, 'vis_reg': 3, 'consist': 50}
...
for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
    ...
    for i, data in pbar:
        ...
        match_gt_loss = l1_criterion(output_1, gt) * lambdas_vis["l1"] + style_reg * lambdas_vis["style"] + perceptual_reg * lambdas_vis["prc"]
